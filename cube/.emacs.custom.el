(custom-set-variables
 ...
 '(package-selected-packages
   '(exec-path-from-shell company-auctex sexy-monochrome-theme poet-theme slime-theme-theme smex pdf-tools multiple-cursors mozc markdown-mode magit ido-completing-read+ gruber-darker-theme ein dash-functional csv-mode company-jedi auctex-latexmk))
