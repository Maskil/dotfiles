...
exec_always --no-startup-id ~/.config/i3/tab.py

# NetworkManager is the most popular way to manage wireless networks on Linux,
# and nm-applet is a desktop environment-independent system tray GUI for it.
exec --no-startup-id nm-applet

exec --no-startup-id xsetroot -solid "#1e264a"
...
# to file
bindsym Shift+Print exec --no-startup-id maim --select "/home/maskil/Pictures/temp.png"

bindsym $mod+k [workspace="__focused__"] kill
